...
export class LoginService {
  ...
  public apiLoginLoginPost(
    ...
    let localVarPath = `/api/login/login`;
  ...
  public apiLoginRefreshPost(
    ...
    let localVarPath = `/api/login/refresh`;
    return this.httpClient.request<LoginResponse>(
      'post',
      `${this.configuration.basePath}${localVarPath}`,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public apiLoginSetPasswordPost(
    loginDto?: LoginDto,
    observe?: 'body',
    reportProgress?: boolean,
    options?: {
  ...
  public apiLoginSetPasswordPost(
    ...
    let localVarPath = `/api/login/setPassword`;
